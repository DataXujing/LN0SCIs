---
title: "LN0SCIs"
author: "JingXu <<https://dataxujing.github.io/>><br>
         XinminLi <<http://maths.qdu.edu.cn/info/1034/1342.htm>><br>
         HuaLiang <<http://maths.qdu.edu.cn/info/1101/2002.htm>>"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{LN0SCIs tutorial}
...
<a href="https://github.com/DataXujing/LN0SCIs/"><img src="pic/log.png" align="right" alt="logo" height="200" width="350" /></a>
...
For the convenience of use, we make a R package called `LN0SCIs`, and it also has a python version package:<https://pypi.python.org/pypi/LN0SCIs>. You can use `vignettes('LN0SCIs-tutorial')` to read the tototial.
